        ...
        <aside className="h-screen">
            <nav className="h-full flex flex-col bg-white border-r shadow-sm">
                ...
                <div className="border-t flex p-3">
                    ...
                    />
                    <div className={`flex justify-between items-center ${expanded ? "w-52 ml-3" : "w-0"}`}>
                        <div className="leading-4">
                            <h4 className="font-semibold">Kevin Khamphounvong</h4>
                            <span className="text-xs text-gray-600">khampkevin@gmail.com</span>
                        </div>
